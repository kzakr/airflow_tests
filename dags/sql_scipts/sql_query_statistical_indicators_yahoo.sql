drop view if exists statistical_indicators; 
create view statistical_indicators as select * from (with aa as (
	select ticker as ticker, full_date as full_date, 
COALESCE (
	full_date_fourteen_day_back,
	full_date_thirteen_day_back,
	full_date_twelve_day_back,
	full_date_eleven_day_back,
	full_date_ten_day_back,
	full_date_nine_day_back,
	full_date_eight_day_back,
	full_date_seven_day_back,
	full_date_six_day_back,
	full_date_five_day_back,
	full_date_four_day_back,
	full_date_three_day_back,
	full_date_two_day_back,
	full_date_one_day_back
) as start_date, CASE WHEN (
...
where (
 ...
 or (
	...
	select ticker as avg_ticker, full_date as avg_full_date, 
COALESCE (
	full_date_fourteen_day_back,
	full_date_thirteen_day_back,
	full_date_twelve_day_back,
...
INSERT INTO statistical_indicators as select * from (with aa as (
...
select Current_DATE, aa.*, bb.* from aa join bb on 
 aa.ticker=bb.avg_ticker AND
 aa.full_date=bb.avg_full_date);
