...
on sql_query.ticker = statistical_metrics_avg.ticker join (select ticker, sum(std_price_unsum) as std_price, sum(std_volume_unsum) as std_volume from 
	(select fr.ticker, fr.full_date, sqrt(power(price - avg_price,2)/full_date_count) as std_price_unsum, sqrt(power(volume - avg_volume,2)/full_date_count) as std_volume_unsum 	from finviz_result fr join (select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(distinct full_date) as full_date_count  from finviz_result  
group by ticker 
having avg(cast (market as decimal))>1500000 
and avg(volume)<>0 and avg(price)<>0 
) avg
	 on fr.ticker = avg.ticker)
...
, b as ( select *, 
 ...
 select * from b where full_date = (select max(full_date) from a)with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20251217) order by full_date desc limit 4) 
group by ticker, full_date 
having avg(cast (market as decimal)) > 2000000) sql_query join 
(select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(distinct full_date) as full_date_count  from finviz_result  
group by ticker 
...
, b as ( select *, 
 ...
 select * from b where full_date = (select max(full_date) from a)with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260106) order by full_date desc limit 4) 
group by ticker, full_date 
having avg(cast (market as decimal)) > 2000000) sql_query join 
(select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(distinct full_date) as full_date_count  from finviz_result  
group by ticker 
...
, b as ( select *, 
 ...
 select * from b where full_date = (select max(full_date) from a)with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260108) order by full_date desc limit 4) 
group by ticker, full_date 
having avg(cast (market as decimal)) > 2000000) sql_query join 
(select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(distinct full_date) as full_date_count  from finviz_result  
group by ticker 
...
, b as ( select *, 
 ...
 select * from b where full_date = (select max(full_date) from a)with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260109) order by full_date desc limit 4) 
group by ticker, full_date 
having avg(cast (market as decimal)) > 2000000) sql_query join 
(select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(distinct full_date) as full_date_count  from finviz_result  
group by ticker 
