drop view if exists ml_temp_validate_yahoo ; 
...
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260624) order by full_date desc limit 55)  
...
where full_date> 20260304 and full_date < 20260610
group by ticker 
...
and avg(volume)<>0 and avg(price)<>0 
	 ...
	 on fr.ticker = avg.ticker where fr.full_date > 20260304 and fr.full_date < 20260610)
where full_date> 20260304 and full_date < 20260610
