drop view if exists ml_temp_validate; 
...
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260605) order by full_date desc limit 55)  
...
where full_date> 20260213 and full_date < 20260522
group by ticker 
...
and avg(volume)<>0 and avg(price)<>0 
	 ...
	 on fr.ticker = avg.ticker where fr.full_date > 20260213 and fr.full_date < 20260522)
where full_date> 20260213 and full_date < 20260522
