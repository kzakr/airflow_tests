...
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260424) order by full_date desc limit 55)  
...
where full_date> 20260102 and full_date < 20260410
group by ticker 
...
and avg(volume)<>0 and avg(price)<>0 
	 ...
	 on fr.ticker = avg.ticker where fr.full_date > 20260102 and fr.full_date < 20260410)
where full_date> 20260102 and full_date < 20260410
