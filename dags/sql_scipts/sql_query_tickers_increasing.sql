INSERT INTO tickers_increasing select * from (with aa as (
	...
	price_ten_day_back > 1.02*price_eleven_day_back  AND 
	price_eleven_day_back > 1.02*price_twelve_day_back  AND 
	price_twelve_day_back > 1.02*price_thirteen_day_back  AND 
	price_thirteen_day_back > 1.02*price_fourteen_day_back  AND 
	price_fourteen_day_back > 1.02*price_fiveteen_day_back ) then add_working_days(full_date, 15)
WHEN (
	price > 1.02*price_two_day_back  AND 
	price_two_day_back > 1.02*price_three_day_back  AND 
	price_three_day_back > 1.02*price_four_day_back  AND 
	...
	price_eleven_day_back > 1.02*price_twelve_day_back  AND 
	price_twelve_day_back > 1.02*price_thirteen_day_back  AND 
	price_thirteen_day_back > 1.02*price_fourteen_day_back ) then add_working_days(full_date, 14)
WHEN (
	price > 1.02*price_two_day_back  AND 
	price_two_day_back > 1.02*price_three_day_back  AND 
	price_three_day_back > 1.02*price_four_day_back  AND 
	...
	price_ten_day_back > 1.02*price_eleven_day_back  AND 
	price_eleven_day_back > 1.02*price_twelve_day_back  AND 
	price_twelve_day_back > 1.02*price_thirteen_day_back ) then add_working_days(full_date, 13)
WHEN (
	price > 1.02*price_two_day_back  AND 
	price_two_day_back > 1.02*price_three_day_back  AND 
	price_three_day_back > 1.02*price_four_day_back  AND 
	...
	price_nine_day_back > 1.02*price_ten_day_back  AND 
	price_ten_day_back > 1.02*price_eleven_day_back  AND 
	price_eleven_day_back > 1.02*price_twelve_day_back ) then add_working_days(full_date, 12)
WHEN (
	price > 1.02*price_two_day_back  AND 
	price_two_day_back > 1.02*price_three_day_back  AND 
	price_three_day_back > 1.02*price_four_day_back  AND 
...
from ( 
	...
	, lag(full_date, 15) OVER (PARTITION BY ticker ORDER BY full_date) AS full_date_fiveteen_day_back
from ( 
	select * from (
...
where (
 ...
 or (
	...
	price_nine_day_back > 1.02*price_ten_day_back  AND 
	price_ten_day_back > 1.02*price_eleven_day_back  AND 
	price_eleven_day_back > 1.02*price_twelve_day_back )
 or (
	price > 1.02*price_two_day_back  AND 
	price_two_day_back > 1.02*price_three_day_back  AND 
	price_three_day_back > 1.02*price_four_day_back  AND 
	...
	price_ten_day_back > 1.02*price_eleven_day_back  AND 
	price_eleven_day_back > 1.02*price_twelve_day_back  AND 
	price_twelve_day_back > 1.02*price_thirteen_day_back )
 or (
	price > 1.02*price_two_day_back  AND 
	price_two_day_back > 1.02*price_three_day_back  AND 
	price_three_day_back > 1.02*price_four_day_back  AND 
	...
	price_eleven_day_back > 1.02*price_twelve_day_back  AND 
	price_twelve_day_back > 1.02*price_thirteen_day_back  AND 
	price_thirteen_day_back > 1.02*price_fourteen_day_back )
 or (
	price > 1.02*price_two_day_back  AND 
	price_two_day_back > 1.02*price_three_day_back  AND 
	price_three_day_back > 1.02*price_four_day_back  AND 
	...
	price_twelve_day_back > 1.02*price_thirteen_day_back  AND 
	price_thirteen_day_back > 1.02*price_fourteen_day_back  AND 
	price_fourteen_day_back > 1.02*price_fiveteen_day_back )
	...
	volume_ten_day_back > 1.02*volume_eleven_day_back  AND 
	volume_eleven_day_back > 1.02*volume_twelve_day_back  AND 
	volume_twelve_day_back > 1.02*volume_thirteen_day_back  AND 
	volume_thirteen_day_back > 1.02*volume_fourteen_day_back  AND 
	volume_fourteen_day_back > 1.02*volume_fiveteen_day_back ) then add_working_days(full_date, 15)
WHEN (
	volume > 1.02*volume_two_day_back  AND 
	volume_two_day_back > 1.02*volume_three_day_back  AND 
	volume_three_day_back > 1.02*volume_four_day_back  AND 
	...
	volume_eleven_day_back > 1.02*volume_twelve_day_back  AND 
	volume_twelve_day_back > 1.02*volume_thirteen_day_back  AND 
	volume_thirteen_day_back > 1.02*volume_fourteen_day_back ) then add_working_days(full_date, 14)
WHEN (
	volume > 1.02*volume_two_day_back  AND 
	volume_two_day_back > 1.02*volume_three_day_back  AND 
	volume_three_day_back > 1.02*volume_four_day_back  AND 
	...
	volume_ten_day_back > 1.02*volume_eleven_day_back  AND 
	volume_eleven_day_back > 1.02*volume_twelve_day_back  AND 
	volume_twelve_day_back > 1.02*volume_thirteen_day_back ) then add_working_days(full_date, 13)
WHEN (
	volume > 1.02*volume_two_day_back  AND 
	volume_two_day_back > 1.02*volume_three_day_back  AND 
	volume_three_day_back > 1.02*volume_four_day_back  AND 
	...
	volume_nine_day_back > 1.02*volume_ten_day_back  AND 
	volume_ten_day_back > 1.02*volume_eleven_day_back  AND 
	volume_eleven_day_back > 1.02*volume_twelve_day_back ) then add_working_days(full_date, 12)
WHEN (
	volume > 1.02*volume_two_day_back  AND 
	volume_two_day_back > 1.02*volume_three_day_back  AND 
	volume_three_day_back > 1.02*volume_four_day_back  AND 
...
where (
 ...
 or (
	...
	volume_nine_day_back > 1.02*volume_ten_day_back  AND 
	volume_ten_day_back > 1.02*volume_eleven_day_back  AND 
	volume_eleven_day_back > 1.02*volume_twelve_day_back )
 or (
	volume > 1.02*volume_two_day_back  AND 
	volume_two_day_back > 1.02*volume_three_day_back  AND 
	volume_three_day_back > 1.02*volume_four_day_back  AND 
	...
	volume_ten_day_back > 1.02*volume_eleven_day_back  AND 
	volume_eleven_day_back > 1.02*volume_twelve_day_back  AND 
	volume_twelve_day_back > 1.02*volume_thirteen_day_back )
 or (
	volume > 1.02*volume_two_day_back  AND 
	volume_two_day_back > 1.02*volume_three_day_back  AND 
	volume_three_day_back > 1.02*volume_four_day_back  AND 
	...
	volume_eleven_day_back > 1.02*volume_twelve_day_back  AND 
	volume_twelve_day_back > 1.02*volume_thirteen_day_back  AND 
	volume_thirteen_day_back > 1.02*volume_fourteen_day_back )
 or (
	volume > 1.02*volume_two_day_back  AND 
	volume_two_day_back > 1.02*volume_three_day_back  AND 
	volume_three_day_back > 1.02*volume_four_day_back  AND 
	...
	volume_twelve_day_back > 1.02*volume_thirteen_day_back  AND 
	volume_thirteen_day_back > 1.02*volume_fourteen_day_back  AND 
	volume_fourteen_day_back > 1.02*volume_fiveteen_day_back )
