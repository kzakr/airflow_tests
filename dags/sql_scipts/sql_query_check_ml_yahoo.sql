...
drop view if exists ml_temp_14_yahoo; 
create view ml_temp_14_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
...
drop view if exists ml_temp_15_yahoo; 
create view ml_temp_15_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
...
drop view if exists ml_temp_16_yahoo; 
create view ml_temp_16_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
...
drop view if exists ml_temp_17_yahoo; 
create view ml_temp_17_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260224) order by full_date desc limit 55)  
group by ticker, full_date 
having avg(cast (market as decimal)) > 2000000) sql_query join 
(select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(*) as full_date_count  from finviz_result  
where full_date> 20251104 and full_date < 20260210
group by ticker 
having avg(cast (market as decimal))>1500000 
and avg(volume)<>0 and avg(price)<>0 
) statistical_metrics_avg 
...
and avg(volume)<>0 and avg(price)<>0 
	 ...
	 on fr.ticker = avg.ticker where fr.full_date > 20251104 and fr.full_date < 20260210)
where full_date> 20251104 and full_date < 20260210
group by ticker) statistical_metrics_std 
on sql_query.ticker = statistical_metrics_std.ticker) where statistical_metrics_avg.avg_volume <>0 and statistical_metrics_avg.avg_price <>0)
, b as ( select *, 
...
drop view if exists ml_temp_18_yahoo; 
create view ml_temp_18_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260226) order by full_date desc limit 55)  
group by ticker, full_date 
having avg(cast (market as decimal)) > 2000000) sql_query join 
(select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(*) as full_date_count  from finviz_result  
where full_date> 20251106 and full_date < 20260212
group by ticker 
having avg(cast (market as decimal))>1500000 
and avg(volume)<>0 and avg(price)<>0 
) statistical_metrics_avg 
...
and avg(volume)<>0 and avg(price)<>0 
	 ...
	 on fr.ticker = avg.ticker where fr.full_date > 20251106 and fr.full_date < 20260212)
where full_date> 20251106 and full_date < 20260212
group by ticker) statistical_metrics_std 
on sql_query.ticker = statistical_metrics_std.ticker) where statistical_metrics_avg.avg_volume <>0 and statistical_metrics_avg.avg_price <>0)
, b as ( select *, 
...
drop view if exists ml_temp_19_yahoo; 
create view ml_temp_19_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260227) order by full_date desc limit 55)  
group by ticker, full_date 
having avg(cast (market as decimal)) > 2000000) sql_query join 
(select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(*) as full_date_count  from finviz_result  
where full_date> 20251107 and full_date < 20260213
group by ticker 
having avg(cast (market as decimal))>1500000 
and avg(volume)<>0 and avg(price)<>0 
) statistical_metrics_avg 
...
and avg(volume)<>0 and avg(price)<>0 
	 ...
	 on fr.ticker = avg.ticker where fr.full_date > 20251107 and fr.full_date < 20260213)
where full_date> 20251107 and full_date < 20260213
group by ticker) statistical_metrics_std 
on sql_query.ticker = statistical_metrics_std.ticker) where statistical_metrics_avg.avg_volume <>0 and statistical_metrics_avg.avg_price <>0)
, b as ( select *, 
...
drop view if exists ml_temp_20_yahoo; 
create view ml_temp_20_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260303) order by full_date desc limit 55)  
group by ticker, full_date 
having avg(cast (market as decimal)) > 2000000) sql_query join 
(select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(*) as full_date_count  from finviz_result  
where full_date> 20251111 and full_date < 20260217
group by ticker 
having avg(cast (market as decimal))>1500000 
and avg(volume)<>0 and avg(price)<>0 
) statistical_metrics_avg 
...
and avg(volume)<>0 and avg(price)<>0 
	 ...
	 on fr.ticker = avg.ticker where fr.full_date > 20251111 and fr.full_date < 20260217)
where full_date> 20251111 and full_date < 20260217
group by ticker) statistical_metrics_std 
on sql_query.ticker = statistical_metrics_std.ticker) where statistical_metrics_avg.avg_volume <>0 and statistical_metrics_avg.avg_price <>0)
, b as ( select *, 
...
drop view if exists ml_temp_21_yahoo; 
create view ml_temp_21_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260305) order by full_date desc limit 55)  
group by ticker, full_date 
having avg(cast (market as decimal)) > 2000000) sql_query join 
(select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(*) as full_date_count  from finviz_result  
where full_date> 20251113 and full_date < 20260219
group by ticker 
having avg(cast (market as decimal))>1500000 
and avg(volume)<>0 and avg(price)<>0 
) statistical_metrics_avg 
...
and avg(volume)<>0 and avg(price)<>0 
	 ...
	 on fr.ticker = avg.ticker where fr.full_date > 20251113 and fr.full_date < 20260219)
where full_date> 20251113 and full_date < 20260219
group by ticker) statistical_metrics_std 
on sql_query.ticker = statistical_metrics_std.ticker) where statistical_metrics_avg.avg_volume <>0 and statistical_metrics_avg.avg_price <>0)
, b as ( select *, 
...
drop view if exists ml_temp_22_yahoo; 
create view ml_temp_22_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
 full_date in (select distinct full_date from finviz_result where full_date not in (select distinct full_date from finviz_result where full_date > 20260310) order by full_date desc limit 55)  
group by ticker, full_date 
having avg(cast (market as decimal)) > 2000000) sql_query join 
(select ticker,  avg(volume) as avg_volume, avg(price) as avg_price,count(*) as full_date_count  from finviz_result  
where full_date> 20251118 and full_date < 20260224
group by ticker 
having avg(cast (market as decimal))>1500000 
and avg(volume)<>0 and avg(price)<>0 
) statistical_metrics_avg 
...
and avg(volume)<>0 and avg(price)<>0 
	 ...
	 on fr.ticker = avg.ticker where fr.full_date > 20251118 and fr.full_date < 20260224)
where full_date> 20251118 and full_date < 20260224
group by ticker) statistical_metrics_std 
on sql_query.ticker = statistical_metrics_std.ticker) where statistical_metrics_avg.avg_volume <>0 and statistical_metrics_avg.avg_price <>0)
, b as ( select *, 
...
drop view if exists ml_temp_23_yahoo; 
create view ml_temp_23_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
...
drop view if exists ml_temp_24_yahoo; 
create view ml_temp_24_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
...
drop view if exists ml_temp_25_yahoo; 
create view ml_temp_25_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
...
drop view if exists ml_temp_26_yahoo; 
create view ml_temp_26_yahoo as select * from (with a as ( 
	 select sql_query.*, statistical_metrics_avg.avg_volume, statistical_metrics_avg.avg_price, statistical_metrics_avg.full_date_count, statistical_metrics_std.std_price, statistical_metrics_std.std_volume from ((select ticker, full_date, avg(price) as price, avg(cast (market as decimal)) as market, avg(volume) as volume  from finviz_result 
where  
